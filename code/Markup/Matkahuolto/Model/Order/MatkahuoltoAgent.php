<?php
namespace Markup\Matkahuolto\Model\Order;

class MatkahuoltoAgent extends \Magento\Framework\DataObject implements \Markup\Matkahuolto\Api\Data\MatkahuoltoAgentInterface
{
  /**
   * {@inheritdoc}
   */
