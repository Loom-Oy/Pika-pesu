define([
    ...
    return Component.extend({
        defaults: {
            template: 'Markup_Matkahuolto/checkout/shipping/agent-search',
        },
        ...
        initialize: function () {
          ...
          self.searchPostcode.subscribe(function() {
            ...
            // Save to cookies
            $.cookie('matkahuoltoSearchPostcode', self.searchPostcode());
          });
          ...
          self.maxResults.subscribe(function(maxResults) {
            $.cookie('matkahuoltoMaxResults', maxResults);
          });
          ...
          self.selectedAgentId.subscribe(function(agentId) {
            ...
            if (agent != false) {
              quote.matkahuoltoAgentId = agentId;
              quote.matkahuoltoAgentData = agent;

              // Save to cookies
              var shippingMethod = quote.shippingMethod();
              if (shippingMethod != null && typeof shippingMethod != 'undefined') {
                var cookieKey = 'matkahuoltoAgentId-' + shippingMethod.method_code.replace('.', '-');
        ...
        setAgentFromCookies: function() {
          ...
          if (shippingMethod != null && typeof shippingMethod != 'undefined') {
            ...
            var cookieMaxResults = $.cookie('matkahuoltoMaxResults');
        ...
        agentsAvailable: function() {
          ...
          var agentMethods = ['80', '10', 'vak'];
          return shippingMethod.carrier_code == 'matkahuolto' && agentMethods.indexOf(shippingMethod.method_code) > -1;
        },
        ...
        updateSearchPostcode: function() {
          ...
          var cookiePostcode = $.cookie('matkahuoltoSearchPostcode');
        ...
        getAgents: function (postcode, method_code) {
          ...
          // Get cache
          var cacheKey = 'cachedMatkahuoltoAgents-' + encodeURIComponent(postcode) + '-' + encodeURIComponent(method_code).replace('.', '-');
          ...
          var serviceUrl = 'rest/V1/matkahuolto/agents?postcode=' + encodeURIComponent(postcode) + '&method=' + encodeURIComponent(method_code);
